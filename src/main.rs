...
fn main() {
    ...
    let answer1_16 = day16::solve1();
    println!("day 16 answer 1 = {answer1_16} time: {:?}", now.elapsed());
    now = Instant::now();
    let answer2_16 = day16::solve2();
    println!("day 16 answer 2 = {answer2_16} time: {:?}", now.elapsed());
    now = Instant::now();
    ...
    now = Instant::now();
    let answer2_21 = day21::solve2();
    println!("day 21 part 2 = {answer2_21} time: {:?}", now.elapsed());
    now = Instant::now();
    ...
    let answer1_23 = day23::solve1();
    println!("day 23 part 1 = {answer1_23} time: {:?}", now.elapsed());
    now = Instant::now();
    let answer2_23 = day23::solve2();
    println!("day 23 part 2 = {answer2_23} time: {:?}", now.elapsed());
    now = Instant::now();

    let answer1_24 = day24::solve1();
    println!("day 24 answer 1 = {answer1_24} time: {:?}", now.elapsed());
    now = Instant::now();
    let answer2_24 = day24::solve2();
    println!("day 24 answer 2 = {answer2_24} time: {:?}", now.elapsed());
    now = Instant::now();

    let answer1_25 = day25::solve1();
    println!("day 25 answer 1 = {answer1_25} time: {:?}", now.elapsed());
}
